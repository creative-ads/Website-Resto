...
if (isset($_SESSION['keranjang']) && !empty($_SESSION['keranjang'])) {
    ...
    foreach ($_SESSION['keranjang'] as $item) {
        ...
        $query = "INSERT INTO delivery (menu, keterangan, jumlah_menu, total_harga, total_harga_setelah_diskon, nama_pemesan, catatan, alamat, no_hp)
                  VALUES ('$menu', '$keterangan', '$jumlah_menu', '$total_harga_item', '$total_harga_setelah_diskon', '$nama_pemesan', '$catatan', '$alamat', '$no_hp' )";
