...
<body>
    ...
    <div class="content">
        <h1><i class="fa fa-pizza-slice"> </i> Cemilan</h1>
        <h3> Admin / Cemilan </h3>
        <hr>
        <?php
        ...
        $sql = "SELECT * FROM cemilan WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ? LIMIT ?, ?";
        ...
        $countSql = "SELECT COUNT(*) AS total FROM cemilan WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ?";
        ...
        <div class="container">
            <div class="cari">
                ...
                <a class="btn btn-primary" href="createcemilan.php" role="button"> <i class="fa fa-plus"></i> Tambah Data</a>
                <a class="btn btn-secondary" href="cemilan.php" role="button"><i class="fa fa-rotate-right"></i> Refresh</a>
            </div>
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="editcemilan.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-pen-to-square"></i></a>
                                    <a class="btn btn-danger" href="hapuscemilan.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-trash-can"></i></a>
                                </td>
                            </tr>
                    <?php
                        }
