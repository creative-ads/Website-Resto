...
include('../koneksi.php');
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM cemilan WHERE id='$id'");
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <form action="updatecemilan.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Edit Menu Cemilan</h2>
