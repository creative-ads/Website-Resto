...
<body>
    ...
    <div class="content">
        <h1><i class="fa fa-burger"> </i> <i class="fa fa-bell-concierge"></i> Menu Lain</h1>
        <h3> Admin / Menu Linnya </h3>
        <hr>
        <?php
        ...
        $sql = "SELECT * FROM menu_lain WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ? LIMIT ?, ?";
        ...
        $countSql = "SELECT COUNT(*) AS total FROM menu_lain WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ?";
        ...
        <div class="container">
            <div class="cari">
                ...
                <a class="btn btn-primary" href="create_menulain.php" role="button"> <i class="fa fa-plus"></i> Tambah Data</a>
                <a class="btn btn-secondary" href="menu_lain.php" role="button"><i class="fa fa-rotate-right"></i> Refresh</a>
            </div>
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="edit_menulain.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-pen-to-square"></i></a>
                                    <a class="btn btn-danger" href="hapus_menulain.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-trash-can"></i></a>
                                </td>
                            </tr>
                    <?php
                        }
                    } else {
                        echo "<tr><td colspan='6'>Tidak ada data Menu Lainnya!! <strong>$query</strong></td></tr>";
                    }
                    ?>
                </tbody>
            </table>
