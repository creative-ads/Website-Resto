...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <form action="uploaddrink.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Tambah Menu Minuman</h2>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file" id="img" name="img[]" accept="image/*" multiple>
                </div>
