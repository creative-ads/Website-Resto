...
<body>
    ...
    <div class="content">
        <h1><i class="fa fa-burger"> </i> Food</h1>
        <h3> Admin / Food </h3>
        <hr>
        <?php
        ...
        $sql = "SELECT * FROM food WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ? LIMIT ?, ?";
        ...
        $countSql = "SELECT COUNT(*) AS total FROM food WHERE menu LIKE ? OR keterangan LIKE ? OR harga LIKE ?";
        ...
        <div class="container">
            <div class="cari">
                ...
                <a class="btn btn-primary" href="createfood.php" role="button"> <i class="fa fa-plus"></i> Tambah Data</a>
                <a class="btn btn-secondary" href="foot.php" role="button"><i class="fa fa-rotate-right"></i> Refresh</a>
            </div>
                ...
                <tbody class="table-group-divider">
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning" href="editfood.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-pen-to-square"></i></a>
                                    <a class="btn btn-danger" href="hapusfood.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-trash-can"></i></a>
                                </td>
                            </tr>
                    <?php
                        }
                    } else {
                        echo "<tr><td colspan='6'>Tidak ada data Makanan!! <strong>$query</strong></td></tr>";
                    }
                    ?>
                </tbody>
            </table>
