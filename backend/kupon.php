...
<body>
    ...
    <div class="content">
        <h1><i class="fa fa-magnifying-glass-dollar"> </i> Kupon</h1>
        <h3> Admin / Kupon Diskon </h3>
        <hr>
        <?php
        ...
        $sql = "SELECT * FROM kupon WHERE kode_diskon LIKE ? OR harga LIKE ? LIMIT ?, ?";
        ...
        $countSql = "SELECT COUNT(*) AS total FROM kupon WHERE kode_diskon LIKE ? OR harga LIKE ?";
        ...
        <div class="container">
            <div class="cari">
                <a class="btn btn-primary" href="createkupon.php" role="button"> <i class="fa fa-plus"></i> Tambah Data</a>
                <a class="btn btn-secondary" href="kupon.php" role="button"><i class="fa fa-rotate-right"></i> Refresh</a>
            </div>
            ...
            <table class="table table-striped">
                ...
                <?php
                    ...
                    ?>
                            <tr>
                                <td><?php echo $id; ?></td>
                                <td><?php echo $baris['kode_diskon']; ?></td>
                                <td><?php echo "Rp " . number_format($baris['harga'], 0, ',', '.'); ?></td>
                                <td>
                                    <a class="btn btn-warning" href="editkupon.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-pen-to-square"></i></a>
                                    <a class="btn btn-danger" href="hapuskupon.php?id=<?php echo $baris['id']; ?>" role="button"><i class="fa fa-trash-can"></i></a>
                                </td>
                            </tr>
                    <?php
                        }
