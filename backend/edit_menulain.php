...
include('../koneksi.php');
$id = $_GET['id'];
$data = mysqli_query($koneksi, "SELECT * FROM menu_lain WHERE id='$id'");
...
<body>
    ...
    <div class="content">
        <div class="form-container">
            <form action="update_menulain.php" method="post" enctype="multipart/form-data">
                <h2 class="form-title">Edit Menu Lain</h2>
